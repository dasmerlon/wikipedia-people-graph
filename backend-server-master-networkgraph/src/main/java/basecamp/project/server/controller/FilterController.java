...
public class FilterController {
	...
	public String users(@RequestParam(value = "person", required=false, defaultValue = "") String person) throws JSONException, ParseException, JsonProcessingException {
	...
	public String converter(String jsonStr, Boolean layer0) throws JSONException, ParseException, JsonProcessingException {
	...
	public JSONObject getSecondLayer(JSONArray nodesLayer1, JSONObject layer0Ausgabe) throws JSONException, ParseException, JsonProcessingException //INPUT CONTACT PERSON ARRAY
	{
		MySQLconnect con = new MySQLconnect();
		System.out.println("Connector erstellt");
		...
		for (int i = 0; i < nodesLayer1.length(); i++) {
			...
			String jsonout = con.getWatson(nextPerson); //hole Beziehungen aus DB
