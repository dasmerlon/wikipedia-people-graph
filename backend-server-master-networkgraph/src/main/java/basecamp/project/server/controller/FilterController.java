...
public class FilterController {
	...
	public String users(@RequestParam(value = "person", required=false, defaultValue = "") String person) throws JSONException, ParseException {
	...
	public JSONObject getSecondLayer(JSONArray nodesLayer1, JSONObject layer0Ausgabe) throws JSONException, ParseException //INPUT CONTACT PERSON ARRAY
	{
		MySQLconnect con = new MySQLconnect();
		System.out.println("Connector erstellt");
		...
		for(Object o: alleDatenLayer2) //alleDatenLayer2 IST ZUSAMMENGEFUEGT AUS AUS CONVERTER OUTPUTS
		{
			JSONObject o2 = (JSONObject)o;
